...
<details>
<summary>1. What is the ONE core problem that Stakeholder Management solves?</summary>
Re-read Part 0 — the mental model section. If you can explain the "why" in one sentence, you understand the foundation.
</details>

<details>
<summary>2. Name the 3 most important terms from the vocabulary section.</summary>
Review Part 1. These are the building blocks every conversation about Stakeholder Management uses.
</details>
...
<details>
<summary>4. What is the most common production pitfall with Stakeholder Management?</summary>
Review the Common Pitfalls section. The first item listed is typically the most frequently encountered.
</details>

<details>
<summary>5. How does Stakeholder Management compare to its closest alternative?</summary>
...
| Dimension | RACI Matrix | Power-Interest Grid | Ad-hoc |
|-----------|-------------|---------------------|--------|
| **Primary use case** | Core strength of RACI Matrix | Core strength of Power-Interest Grid | Core strength of Ad-hoc |
