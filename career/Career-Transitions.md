...
<details>
<summary>1. What is the ONE core problem that Career Transitions solves?</summary>
Re-read Part 0 — the mental model section. If you can explain the "why" in one sentence, you understand the foundation.
</details>

<details>
<summary>2. Name the 3 most important terms from the vocabulary section.</summary>
Review Part 1. These are the building blocks every conversation about Career Transitions uses.
</details>
...
<details>
<summary>4. What is the most common production pitfall with Career Transitions?</summary>
Review the Common Pitfalls section. The first item listed is typically the most frequently encountered.
</details>

<details>
<summary>5. How does Career Transitions compare to its closest alternative?</summary>
...
| Dimension | Lateral Move | Upward Move | Domain Switch |
|-----------|--------------|-------------|---------------|
| **Primary use case** | Core strength of Lateral Move | Core strength of Upward Move | Core strength of Domain Switch |
