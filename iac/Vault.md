...
<details>
<summary>1. What is the ONE core problem that Vault solves?</summary>
Re-read Part 0 — the mental model section. If you can explain the "why" in one sentence, you understand the foundation.
</details>

<details>
<summary>2. Name the 3 most important terms from the vocabulary section.</summary>
Review Part 1. These are the building blocks every conversation about Vault uses.
</details>
...
<details>
<summary>4. What is the most common production pitfall with Vault?</summary>
Review the Common Pitfalls section. The first item listed is typically the most frequently encountered.
</details>

<details>
<summary>5. How does Vault compare to its closest alternative?</summary>
...
| Dimension | Vault | AWS Secrets Mgr | Azure Key Vault |
|-----------|-------|-----------------|-----------------|
| **Primary use case** | Core strength of Vault | Core strength of AWS Secrets Mgr | Core strength of Azure Key Vault |
