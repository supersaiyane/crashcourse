...
<details>
<summary>1. What is the ONE core problem that Chaos Engineering solves?</summary>
Re-read Part 0 — the mental model section. If you can explain the "why" in one sentence, you understand the foundation.
</details>

<details>
<summary>2. Name the 3 most important terms from the vocabulary section.</summary>
Review Part 1. These are the building blocks every conversation about Chaos Engineering uses.
</details>
...
<details>
<summary>4. What is the most common production pitfall with Chaos Engineering?</summary>
Review the Common Pitfalls section. The first item listed is typically the most frequently encountered.
</details>

<details>
<summary>5. How does Chaos Engineering compare to its closest alternative?</summary>
...
| Dimension | Chaos Engineering | Load Testing | Game Days |
|-----------|-------------------|--------------|-----------|
| **Primary use case** | Core strength of Chaos Engineering | Core strength of Load Testing | Core strength of Game Days |
