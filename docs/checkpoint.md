...
| 2026-06-05 01:30 | Fix lab exercise links — intercept relative .md links | Done | Exercise/next-stage links inside rendered lab READMEs were 404ing (resolved relative to docs/). Now intercepted via click handler, resolved from stage dir, rendered in-app with "Back to README" button. Applies to all projects/stages. | docs/js/app.js:1198-1235 |
