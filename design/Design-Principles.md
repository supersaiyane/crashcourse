...
<details>
<summary>1. What is the ONE core problem that Design Principles solves?</summary>
Re-read Part 0 — the mental model section. If you can explain the "why" in one sentence, you understand the foundation.
</details>

<details>
<summary>2. Name the 3 most important terms from the vocabulary section.</summary>
Review Part 1. These are the building blocks every conversation about Design Principles uses.
</details>
...
<details>
<summary>4. What is the most common production pitfall with Design Principles?</summary>
Review the Common Pitfalls section. The first item listed is typically the most frequently encountered.
</details>

<details>
<summary>5. How does Design Principles compare to its closest alternative?</summary>
...
| Dimension | SOLID | KISS/YAGNI | DRY |
|-----------|-------|------------|-----|
| **Primary use case** | Core strength of SOLID | Core strength of KISS/YAGNI | Core strength of DRY |
